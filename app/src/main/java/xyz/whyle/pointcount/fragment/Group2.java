...
import xyz.whyle.pointcount.adapter.RecyclerViewAdapterGroup2;
...
public class Group2 extends Fragment{
    ...
    public static final String TAG = "Group2 ";
    public static View myView;
	public static RecyclerView mRecyclerView;
	public static ArrayList<MyData.Data> data = new ArrayList<>();
	public static RecyclerViewAdapterGroup2 adapter;
	public static SwipeRefreshLayout swipeRefreshLayout;
	public static Context mContext;
	
	public static Group2 newInstance(Context c) {
		Log.d(TAG, "newInstance");
		Bundle args = new Bundle();
		args.putLong("EXTRA_DATE", 0);

		Group2 fragment = new Group2(c);
		fragment.setArguments(args);
		return fragment;
	}
	public Group2(){}
    public Group2(Context mContext){ this.mContext = mContext;};
	...
	public static void init()
	{
		...
		Runnable get = new Runnable(){
			...
			public void run()
			{
				String json = ServerData.getFromGroup(ServerData.GROUP2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		adapter = new RecyclerViewAdapterGroup2();
		...
		init();
        adapter.setOnItemClickListener(new RecyclerViewAdapterGroup2.OnItemClickListener() {
