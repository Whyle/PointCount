...
import xyz.whyle.pointcount.adapter.RecyclerViewAdapterGroup4;
...
public class Group4 extends Fragment{
    ...
    public static final String TAG = "Group4 ";
    public static View myView;
	public static RecyclerView mRecyclerView;
	public static ArrayList<MyData.Data> data = new ArrayList<>();
	public static RecyclerViewAdapterGroup4 adapter;
	public static SwipeRefreshLayout swipeRefreshLayout;
	public static Context mContext;

	public static Group4 newInstance(Context c) {
		Log.d(TAG, "newInstance");
		Bundle args = new Bundle();
		args.putLong("EXTRA_DATE", 0);

		Group4 fragment = new Group4(c);
		fragment.setArguments(args);
		return fragment;
	}
	public Group4(){}
    public Group4(Context mContext){ this.mContext = mContext;};
	...
	public static void init()
	{
		...
		Runnable get = new Runnable(){
			...
			public void run()
			{
				String json = ServerData.getFromGroup(ServerData.GROUP0);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		adapter = new RecyclerViewAdapterGroup4();
        ...
        adapter.setOnItemClickListener(new RecyclerViewAdapterGroup4.OnItemClickListener() {
