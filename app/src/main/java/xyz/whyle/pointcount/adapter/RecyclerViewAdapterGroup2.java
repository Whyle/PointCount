...
public class RecyclerViewAdapterGroup2 extends RecyclerView.Adapter<RecyclerViewAdapterGroup2.ViewHolder>
{
	...
	public RecyclerViewAdapterGroup2() {
	}
	...
	@Override
	public RecyclerViewAdapterGroup2.ViewHolder onCreateViewHolder(ViewGroup parent,
															 int viewType) {
		// create a new view
